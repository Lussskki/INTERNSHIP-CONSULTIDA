...
const Page = () => {
  ...
  async function getData(page) {
    const data = await api.getAppointments(page);
    setData(data);
  }
  ...
  return (
    <div data-theme="light">
      <Head>
        ...
        <meta name="description" content="List of current appointments"></meta>
        <meta property="og:type" content="article" />
        <meta property="og:title" content="User - Appointments" />
        <meta
          property="og:description"
          content="List of current appointments"
        />
      </Head>
      <Layout>
        <ProtectedRoute>
            ...
            <div className="bg-white py-[72px]">
              {data ? (
                ...
                <span className="flex items-center justify-center text-sm max-w-[613px] mb-[10px]">
                  {t("youDontHaveBookedAppointments")}
                </span>
              )}
            </div>
          </div>
